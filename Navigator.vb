...
Public Class Navigator
    ...
    Public Shared Function GetJScriptURL(ByVal TargetLocation As String, Optional ByVal Param1 As Object = Nothing, Optional ByVal Param2 As Object = Nothing, Optional ByVal Param3 As Object = Nothing, Optional ByVal Param4 As Object = Nothing, Optional ByVal Param5 As Object = Nothing, Optional ByVal Param6 As Object = Nothing, Optional ByVal Param7 As Object = Nothing, Optional ByVal Param8 As Object = Nothing, Optional ByVal Param9 As Object = Nothing) As String
        Select Case TargetLocation
            ...
            Case "Jump"
                Return "jump.aspx?WFlowID=" & Param1 & "&ID=" & Param2 & "&a=" & Param3 & "&ID2=" & Param4
            Case "EditFormDevice"
            ...
            Case "SendForReview"
                ...
                Return "sendforreview.aspx?ID=" & strParam1 & "&InstanceID=" & Param3 & "&NodeID=" & Param4 & "&ID2=" & Param5 & "&a=" & Param6
            ' Else
            ...
            Case "SendForInput"
                Dim strParam1 As String = Param1
                '   If GlobalFunctions.FormatBoolean(Param2) = True Then
                Return "sendforreview.aspx?SFI=1&ID=" & strParam1 & "&InstanceID=" & Param3 & "&NodeID=" & Param4 & "&ID2=" & Param5 & "&a=" & Param6
            '   Else
            ...
            Case "CorrectionDone"
                ...
                Return "correctionmade.aspx?ID=" & strParam1 & "&OriginatorID=" & strParam2 & "&InstanceID=" & strParam3 & "&a=" & Param4
            Case "InputDone"
                Dim strParam1 As String = Param1
                Dim strParam2 As String = Param2
                Dim strParam3 As String = Param3
                Dim strParam5 As String = Param5
                Return "correctionmade.aspx?SFI=1&ID=" & strParam1 & "&OriginatorID=" & strParam2 & "&InstanceID=" & strParam3 & "&a=" & Param4 & "&TaskID=" & strParam5
            Case "Correction"
                Dim strParam1 As String = Param1
                Return "action.aspx?Action=Correction&ID=" & strParam1
            Case "UserLists"
            ...
            Case "ExportWebPage"
                Return "ExportWebPage.aspx?AppID=" & Param1 & "&ID=" & Param2
            Case "EditViewStyles"
            ...
            Case "FillForm2"
                Return "fillform.aspx?ListID=" & CStr(Param1) & "&ID=" & CStr(Param2) & IIf(Len(Param3) > 0, "&Origin=" & System.Web.HttpContext.Current.Server.UrlEncode(CStr(Param3)), "") & "&a=" & Param4 & IIf(Len(Param5) > 0, "&InboxID=" & Param5, "") & IIf(Len(Param6) > 0, "&Actions=" & Param6, "") & IIf(Len(Param7) > 0, "&NoFRM=" & Param7, "") & IIf(Len(Param8) > 0, "&OPID=" & Param8, "") & GetQSRemains(Param9)
            Case "CustomFillForm2"
                Return CStr(Param1) & "?ListID=" & CStr(Param2) & "&ID=" & CStr(Param3)
            Case "FillForm2RO"
                Return "fillform.aspx?FT=1&RO=1&ListID=" & CStr(Param1) & "&ID=" & CStr(Param2) & "&a=" & CStr(Param3) & GetQSRemains(Param9)
            Case "SearchPage"
            ...
            Case "LaunchView"
                Return "FormList.aspx?ViewID=" & Param1 & "&a=" & Param2
            Case "LaunchCalView"
            ...
            Case "FillForm"
                Return "fillform.aspx?FT=1&ListID=" & Param1 & "&a=" & Param2 & GetQSRemains(Param9)
            Case "CustomFillForm"
                Return Param1 & "?FT=1&ListID=" & Param2
            Case "FormList"
                Return "formlist.aspx?ViewID=" & Param1 & "&a=" & Param2 & GetQSRemains(Param9)
            Case "FillForm2"
                Return "fillform.aspx?FT=1&ListID=" & Param1 & "&ID=" & Param2 & "&a=" & Param3
            Case "FillFormEdit"
                Return "fillform.aspx?FT=1&ListID=" & Param1 & "&ID=" & Param2 & "&Origin=" & System.Web.HttpContext.Current.Server.UrlEncode(Param3) & "&a=" & Param4 & IIf(Len(Param5) > 0, "#JumpHere", "")
            Case "FillFormAmend"
                Return "fillform.aspx?Amend=1&FT=1&ListID=" & Param1 & "&ID=" & Param2 & "&Origin=" & System.Web.HttpContext.Current.Server.UrlEncode(Param3) & "&a=" & Param4 & IIf(Len(Param5) > 0, "#JumpHere", "")
            Case "FillFormEditAction"
                Return "fillform.aspx?FT=1&ListID=" & Param1 & "&ID=" & Param2 & "&Origin=" & System.Web.HttpContext.Current.Server.UrlEncode(Param3) & "&a=" & Param4 & "&InboxID=" & Param6 & "&Actions=" & System.Web.HttpContext.Current.Server.UrlEncode(Param7) & IIf(Len(Param5) > 0, "#JumpHere", "")
            Case "Application"
                Return "application.aspx?ID=" & Param1
            Case "MainHandler"
                Return "~\weberror.aspx?err=Unhandled"
            Case "Reassign"
                Dim strParam1 As String = Param1
                Return "reassign.aspx?a=" & Param2 & "&ID=" & strParam1
            Case "SubmissionView"
                Dim strParam1 As String = Param1
                Return "Submission.aspx?FT=1&ID=" & strParam1 & "&a=" & Param2 & "&acid=" & Param9
            Case "Inbox"
                Return "Default.aspx?a=" & Param1
            Case "MySubmissions"
                Return "MySubmissions.aspx?a=" & Param1
            Case "DesignWorkflow"
                Dim strParam1 As String = Param1
                Return "designworkflow.aspx?ID=" & strParam1
            Case "Approve"
                Dim strParam1 As String = Param1
                Return "action.aspx?a=" & Param2 & "&Action=Approve&ID=" & strParam1
            Case "StandardAction"
                Dim strParam1 As String = Param1
                Return "action.aspx?a=" & Param2 & "&Action=" & Param3 & "&ID=" & strParam1
            Case "Correction"
                Dim strParam1 As String = Param1
                Return "action.aspx?Action=Correction&ID=" & strParam1
            Case "CustomAction"
                Dim strParam1 As String = Param1
                Dim strParam2 As String = Param2
                Return "action.aspx?a=" & Param3 & "&Action=Custom&CustomName=" & strParam2 & "&ID=" & strParam1
            Case "Reject"
                Dim strParam1 As String = Param1
                Return "action.aspx?a=" & Param2 & "&Action=Reject&ID=" & strParam1
            Case "WorkflowStatus"
                Dim strParam1 As String = Param1
                Dim strParam2 As String = Param2
                Dim strParam3 As String = Param3
                ...
                If Len(strParam3) > 0 Then
                    Return "workflowstatus.aspx?a=" & Param5 & "&noframe=1&ID=" & strParam1 & "&TaskID=" & strParam2 & strParam4
                Else
                    Return "workflowstatus.aspx?a=" & Param5 & "&ID=" & strParam1 & "&TaskID=" & strParam2 & strParam4
                End If
            ...
            Case "ActionScreen"
                Dim strParam1 As String = Param1
                Return "actionscreen.aspx?FT=1&ID=" & strParam1 & "&a=" & Param2
            Case "CancelSubmission"
                Dim strParam1 As String = Param1
                Return "Submission.aspx?FT=1&CS=1&ID=" & strParam1 & "&a=" & Param2
            Case "Workflows"
            ...
            Case "PostMessage"
                ...
                If Len(strParam2) > 0 Then
                    Return "postmessage.aspx?a=" & Param4 & "&FS=" & strParam3 & "&ReplyTo=" & strParam2 & "&ID=" & strParam1
                Else
                    Return "postmessage.aspx?a=" & Param4 & "&FS=" & strParam3 & "&ID=" & strParam1
                End If
    ...
    Public Shared Function Navigate(ByVal TargetLocation As String, Optional ByVal Param1 As Object = Nothing, Optional ByVal Param2 As Object = Nothing, Optional ByVal Param3 As Object = Nothing, Optional ByVal Param4 As Object = Nothing, Optional ByVal Param5 As Object = Nothing, Optional ByVal Param6 As Object = Nothing, Optional ByVal Param7 As Object = Nothing, Optional ByVal Param8 As Object = Nothing, Optional ByVal param9 As Object = Nothing, Optional ByVal param10 As Object = Nothing) As String
        Try
            ...
            Select Case TargetLocation
                ...
                Case "CustomAction"
                    Dim strParam1 As String = Param1
                    Dim strParam2 As String = Param2
                    Current.Response.Redirect("action.aspx?a=" & Param3 & "&Action=Custom&CustomName=" & strParam2 & "&ID=" & strParam1)
                Case "ChangeHistory"
                ...
                Case "submission"
                    Current.Response.Redirect("submission.aspx?ID=" & CStr(Param1) & "&a=" & Param2 & "&FT=1")
                Case "ImportAsCSV"
                ...
                Case "NewFillForm"
                    Current.Response.Redirect("fillform.aspx?ListID=" & CStr(Param1) & "&FT=1&a=" & Param2 & IIf(Len(Param3) > 0, "&", "") & Param3)
                Case "NewFillFormWithDefaults"
                    Current.Response.Redirect("fillform.aspx?Def=" & Param3 & "&ListID=" & CStr(Param1) & "&FT=1&a=" & Param2)
                Case "FillForm"
                    Current.Response.Redirect("fillform.aspx?ListID=" & CStr(Param1) & "&ParentRec=" & CStr(Param2) & IIf(Len(Param3) > 0, "&Origin=" & CStr(Param3), "") & "&a=" & Param4 & IIf(Len(Param5) > 0, "&InboxID=" & Param5, "") & IIf(Len(Param6) > 0, "&Actions=" & Param6, "") & IIf(Len(Param7) > 0, "&NoFRM=" & Param7, "") & IIf(Len(Param8) > 0, "&New=" & Param8, "") & GetQSRemains(param10))
                Case "FillFormEdit"
                    Current.Response.Redirect("fillform.aspx?FT=1&ListID=" & CStr(Param1) & "&ID=" & CStr(Param2) & "&a=" & Param3 & GetQSRemains(param9))
                Case "FillFormRO"
                    Current.Response.Redirect("fillform.aspx?RO=1&FT=1&ListID=" & CStr(Param1) & "&ID=" & CStr(Param2) & "&a=" & Param3 & "&NoFRM=" & Param4 & GetQSRemains(param9))
                Case "FormList"
                    Current.Response.Redirect("FormList.aspx?ViewID=" & CStr(Param1) & "&Sort=" & Param2 & "&Dir=" & Param3)
                Case "LaunchView"
                    Current.Response.Redirect("FormList.aspx?ViewID=" & CStr(Param1) & "&a=" & Param2 & "&acid=" & Param3)
                Case "FillForm2"
                    Current.Response.Redirect("fillform.aspx?ListID=" & CStr(Param1) & "&ID=" & CStr(Param2) & IIf(Len(Param3) > 0, "&Origin=" & CStr(Param3), "") & "&a=" & Param4 & IIf(Len(Param5) > 0, "&InboxID=" & Param5, "") & IIf(Len(Param6) > 0, "&Actions=" & Param6, "") & IIf(Len(Param7) > 0, "&NoFRM=" & Param7, "") & IIf(Len(Param8) > 0, "&OPID=" & Param8, "") & GetQSRemains(param9))
                Case "FillForm5"
                    Current.Response.Redirect("fillform.aspx?ListID=" & CStr(Param1) & "&ParentRec=" & CStr(Param2) & IIf(Len(Param3) > 0, "&Origin=" & CStr(Param3), "") & "&a=" & Param4 & IIf(Len(Param5) > 0, "&InboxID=" & Param5, "") & IIf(Len(Param6) > 0, "&Actions=" & Param6, "") & IIf(Len(Param7) > 0, "&NoFRM=" & Param7, "") & IIf(Len(Param8) > 0, "&OPID=" & Param8, "") & GetQSRemains(param9))
                Case "CustomFillForm2"
                ...
                Case "ActionScreen"
                    Dim strParam1 As String = Param1
                    Current.Response.Redirect("actionscreen.aspx?FT=1&ID=" & strParam1 & "&a=" & Param2)
                Case "ActionScreenFull"
                    Dim strParam1 As String = Param1
                    Current.Response.Redirect("actionscreen.aspx?FT=1&ID=" & strParam1 & "&a=" & Param2 & "&ID2=" & Param3)
                Case "MFPInstances"
                ...
                Case "MySubmissions"
                    ...
                    If Len(strParam1) > 0 Or Len(strParam2) > 0 Then
                        Current.Response.Redirect("mysubmissions.aspx?Category=" & strParam1 & "&Status=" & strParam2)
                    Else
                        Current.Response.Redirect("mysubmissions.aspx")
                    End If
                Case "Login"
                    ...
                    Dim shouldRedirectNotReturnUrl As Boolean = GlobalFunctions.FormatBoolean(Param2, True)
                    If shouldRedirectNotReturnUrl Then
                ...
                Case "Divisions"
                    Current.Response.Redirect("divisions.aspx")
                Case "NewDivision"
                    Current.Response.Redirect("division.aspx")
                Case "PublicHolidays"
                ...
                Case "SaveToFT8ConfigEdit"
                    ...
                    'Current.Response.Redirect("sendtoftconfig.aspx?WorkflowID=" & strParam1 & "&ID=" & strParam2)
                ...
                Case "InstanceViewer"
                    Dim strParam1 As String = Param1
                    Current.Response.Redirect("Submission.aspx?FT=1&noframe=1&ID=" & strParam1)
                Case "SendEmail"
                    Dim strParam1 As String = Param1
                ...
                Case "SubmissionView"
                    Dim strParam1 As String = Param1
                    Current.Response.Redirect("Submission.aspx?FT=1&ID=" & strParam1 & "&a=" & Param2)
                Case "SubmissionViewPC"
                    Dim strParam1 As String = Param1
                    Current.Response.Redirect("Submission.aspx?FT=1&PC=1&ID=" & strParam1 & "&a=" & Param2)
                Case "OutgoingMails"
    ...
    Public Shared Sub RaiseWebError(ByVal WebError As String, Optional ByVal Tag As String = "")
        logger.Debug("start, WebError: " + WebError)
        ...
        Dim errorPage As String = "weberror.aspx"
        If Len(GlobalFunctions.FromConfig("CustomErrorPage")) > 0 Then
            errorPage = GlobalFunctions.FromConfig("CustomErrorPage")
        End If
